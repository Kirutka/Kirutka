...
<div id="badges">
  <a href="your-linkedin-URL">
    <img src="https://img.shields.io/badge/Telegram-Congo blue?style=for-the-badge&logo=Telegram&logoColor=white" alt="Telegram Badge"/>
  </a>
...
Я **развиваюсь** как в области front-end, так и back-end разработки и занимаюсь своими проектами. Мне нравится учиться и создавать что-то новое, своё, инновационное и креативное.

**За пределами кода:** Когда я не за компьютером, вы можете найти меня в спортзале, за чтением книги или в поисках следующего места для путешествия.
